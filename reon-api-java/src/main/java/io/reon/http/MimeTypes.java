...
public class MimeTypes {
	 ...
	 */
	private static void registerMimeType(String ext, String mimeType) {
	...
	private static String extension(String fullFilename) {
		int lastSlashIdx = fullFilename.lastIndexOf("/");
		String file;
		if (lastSlashIdx != -1) {
			file = fullFilename.substring(lastSlashIdx);
		} else {
			file = fullFilename;
		}
		String ext;
