...
import io.reon.processor.MyAnnotationProcessor;

import static java.util.Arrays.asList;
import static org.junit.Assert.assertFalse;
import static org.junit.Assert.assertTrue;

public abstract class ReonTestCase {

	private static final String SRC_TEST_DIR = "src/main/java";

	private static final String JAVA_FILE_EXT = ".java";

	private static final String OUT_DIR = "reon-test/build/generated-test-src/test/java";
